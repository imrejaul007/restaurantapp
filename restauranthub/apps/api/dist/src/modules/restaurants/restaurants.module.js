...
exports.RestaurantsModule = RestaurantsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [restaurants_service_1.RestaurantsService, branches_service_1.BranchesService],
        controllers: [restaurants_controller_1.RestaurantsController, branches_controller_1.BranchesController],
        exports: [restaurants_service_1.RestaurantsService, branches_service_1.BranchesService],
    })
], RestaurantsModule);

...
var FrontendIntegrationService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.FrontendIntegrationService = void 0;
const common_1 = require("@nestjs/common");
const database_service_1 = require("../database/database.service");
let FrontendIntegrationService = FrontendIntegrationService_1 = class FrontendIntegrationService {
    constructor(databaseService) {
        this.databaseService = databaseService;
        this.logger = new common_1.Logger(FrontendIntegrationService_1.name);
    }
    formatResponse(data, message, pagination, meta) {
        return {
            success: true,
            data,
            message,
    ...
    formatErrorResponse(error, statusCode, meta) {
        return {
            success: false,
            error,
            meta: {
...
exports.FrontendIntegrationService = FrontendIntegrationService;
exports.FrontendIntegrationService = FrontendIntegrationService = FrontendIntegrationService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [database_service_1.DatabaseService])
], FrontendIntegrationService);
//# sourceMappingURL=frontend-integration.service.js.map
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'all', required: false, description: 'Logout from all devices' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Email already verified or rate limited' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Session not found' }),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Auth service health check' }),

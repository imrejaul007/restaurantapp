            ...
            {isAuthenticated && user ? (
              <>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="sm" className="relative h-10 w-10 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 group">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="sm" className="flex items-center space-x-3 px-3 py-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 group">
              ...
              <div className="flex items-center space-x-3">
                <Link href="/auth/login">
                  <Button variant="ghost" size="sm" className="font-medium hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full px-4 transition-all duration-200">
                    Login
                  </Button>
                </Link>
                <Link href="/auth/signup">
                  <Button size="sm" className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-medium rounded-full px-6 shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all duration-200 hover:scale-105">
                    Get Started
                  </Button>
                </Link>
              </div>
